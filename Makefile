...
default:
	...
	gcc -m64 -march=native -mtune=native -mssse3 -Wall -Wextra -Wno-deprecated-copy -Ofast -ftree-vectoriz -o Auto AutoDivison.c gmpecc.c util.o bloom.o base58.o sha256.o rmd160.o xxhash.o -lgmp -pthread
