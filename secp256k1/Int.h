...
#define HAS_BUILTIN_ADDCARRY
#endif
#endif

#ifdef HAS_BUILTIN_ADDCARRY
#define _addcarry_u64(c, a, b, r) __builtin_ia32_addcarryx_u64((unsigned char)(c), (unsigned long long)(a), (unsigned long long)(b), (unsigned long long *)(r))
#define _subborrow_u64(c, a, b, r) __builtin_ia32_subborrow_u64((unsigned char)(c), (unsigned long long)(a), (unsigned long long)(b), (unsigned long long *)(r))
#else
